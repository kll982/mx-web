...
export default class customerlist extends React.Component {
	constructor(props) {
		...
		this.state = {
			...
			deleteTempIdData:[],
			addTempIdData:[],
			plainOptions:['轻微瑕疵', '一般瑕疵', '一手','非一手'],
			plainOptions1:[{value:"jichujiage",text:"基础价格"},{value:"qingweiXiaci",text:"轻微瑕疵"},{value:"yibanXiaci",text:"一般瑕疵"},{value:"yishou",text:"一手"},{value:"feiyishou",text:"非一手"}],
	...
	onCheckChange=(checkedValues) =>{
		...
		var first1=includeItem(checkedValues,'轻微瑕疵');
		self.setState({
			firstTypeMake:first1
		})
		var second1=includeItem(checkedValues,'一般瑕疵');
		self.setState({
			secondTypeMake:second1
		})
		var third1=includeItem(checkedValues,'一手');
		self.setState({
			thirdTypeMake:third1
		})
		var four1=includeItem(checkedValues,'非一手');
		self.setState({
			four1TypeMake:four1
		})
	...
	<div className={styles.boxcontent}>
		...
		<div className={styles.flexRow+" "+styles.rightBorder}>
			...
			{this.state.plainOptions1.map((item4,index)=>{
				return (
					<div className={styles.push1+" "+styles.flexFullItem}>{item4.text}</div>
				)
			})}
				{/* <div className={styles.push1+" "+styles.flexFullItem}>基础价格</div>
				<div className={styles.push1+" "+styles.flexFullItem}>轻微瑕疵</div>
				<div className={styles.push1+" "+styles.flexFullItem}>一般瑕疵</div>
				<div className={styles.push1+" "+styles.flexFullItem}>一手</div>
				<div className={styles.push1+" "+styles.flexFullItem}>非一手</div> */}
			</div>
		</div>
		<div className={styles.flexRow+" "+styles.rightBorder}>
